...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ary-Latn" lang="ary-Latn" dir="ltr"><head><title>{html.escape(title)}</title><link rel="stylesheet" type="text/css" href="styles.css" /></head><body dir="ltr">{body}</body></html>'''
...
def epub(path: Path, markdown: str, sources_list: list[dict], cover_bytes: bytes, date: str) -> None:
    ...
    css = "html,body,nav,article,section,ol,li{direction:ltr;text-align:left;unicode-bidi:normal}body{font-family:serif;line-height:1.55;margin:6%;color:#172b2a}h1{color:#9b442e}h2{color:#142c2b;margin-top:1.5em}a{color:#176b5b;word-break:break-word}li{margin-bottom:1em}img{max-width:100%;height:auto}.visually-hidden{position:absolute;left:-10000px}"
    opf = f'''<?xml version="1.0" encoding="utf-8"?>
<package xmlns="http://www.idpf.org/2007/opf" version="3.0" unique-identifier="publication-id" xml:lang="ary-Latn" dir="ltr"><metadata xmlns:dc="http://purl.org/dc/elements/1.1/"><dc:identifier id="publication-id">dragon-{date}-v1.1</dc:identifier><dc:title>DRAGON Daily Newspaper - {date}</dc:title><dc:language>ary-Latn</dc:language><dc:creator>DRAGON Editorial Desk</dc:creator><dc:date>{date}</dc:date><dc:description>{LABEL}</dc:description><meta name="cover" content="cover-image"/></metadata><manifest><item id="nav" href="nav.xhtml" media-type="application/xhtml+xml" properties="nav"/><item id="cover-image" href="cover.webp" media-type="image/webp" properties="cover-image"/><item id="cover-page" href="cover.xhtml" media-type="application/xhtml+xml"/><item id="style" href="styles.css" media-type="text/css"/>{"".join(items)}</manifest><spine page-progression-direction="ltr">{"".join(spine)}</spine></package>'''
