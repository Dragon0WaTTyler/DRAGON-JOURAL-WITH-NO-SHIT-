...
If a prerequisite or GitHub operation blocks this run, record BLOCKED honestly but never pause, disable, delete or modify any recurring ChatGPT schedule. The next invocation must retry after current read-back.
